...
You can then execute your native executable with: `./target/hello-kamelk-1.0.0-SNAPSHOT-runner`
...
- Camel Ref ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/ref.html)): Route messages to an endpoint looked up dynamically by name in the Camel Registry
